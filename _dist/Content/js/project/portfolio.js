...
function (view, formLogin)
{
    ...
    {    
        ...
        {          
            ...
            window.tEvent.addListener(window.tEvent.eventStr.EVENT_LOAD_PORTFOLIO, function(evt, data)
            {
        ...
        {   
            console.log(" * <portfolio.onPageLoad>");
            this.oView.loadPageTemplate(window.oTemplates.p_portfolio());
